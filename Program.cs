...
namespace ConsoleApp1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Product monitor = new Product( 1, "Monitor", "Electronics",  7.2, 10, 5);

            Product keyboard = new Product( 2, "Keyboard", "Electronics", 0.8, 35, 10);

            Product mouse = new Product( 3, "Mouse", "Accessories", 0.2, 80, 20);
            ...
            while (running)
            {
                ...
                Console.WriteLine("6. Warehouse Analytics");
                Console.WriteLine("7. Save Warehouse");
                Console.WriteLine("8. Load Warehouse");
                ...
                switch (choice)
                {
                    ...
                    case "6":
                        WarehouseAnalytics.DisplayReport(warehouse);
                        break;

                    case "7":
                        try
                        {
                            WarehousePersistence.Save(warehouse);
                        }
                        catch (WarehousePersistenceException ex)
                        {
                    ...
                    case "8":
                        try
                        {
                            ...
                            warehouse = WarehousePersistence.Load();
        ...
        static void RunEventDemo(Warehouse warehouse)
        {
            ...
            warehouse.Monitor.OnTaskRemoved += consoleSub.OnTaskRemoved;
        ...
        static void CreateTask(Warehouse warehouse)
        {
            ...
            WarehouseTask task = warehouse.CreateTask(
                type,
                workload,
                orderAge,
                resourceScarcity,
        ...
        static void DeleteTask(Warehouse warehouse)
        {
            ...
            bool removed = warehouse.RemoveTask(taskID);
